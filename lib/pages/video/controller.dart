...
import 'package:PiliNext/grpc/bilibili/app/listener/v1.pbenum.dart'
    show PlaylistSource;
...
import 'package:PiliNext/models/common/account_type.dart';
...
import 'package:PiliNext/models/common/sponsor_block/segment_model.dart';
...
import 'package:PiliNext/models/common/video/subtitle_pref_type.dart';
...
import 'package:PiliNext/models_new/media_list/media_list.dart';
import 'package:PiliNext/models_new/pgc/pgc_info_model/result.dart';
...
import 'package:PiliNext/models_new/video/video_pbp/data.dart';
import 'package:PiliNext/models_new/video/video_play_info/subtitle.dart';
import 'package:PiliNext/models_new/video/video_stein_edgeinfo/data.dart';
import 'package:PiliNext/pages/audio/view.dart';
import 'package:PiliNext/pages/common/publish/publish_route.dart';
import 'package:PiliNext/pages/search/widgets/search_text.dart';
import 'package:PiliNext/pages/sponsor_block/block_mixin.dart';
import 'package:PiliNext/pages/video/download_panel/view.dart';
...
import 'package:PiliNext/pages/video/medialist/view.dart';
import 'package:PiliNext/pages/video/note/view.dart';
import 'package:PiliNext/pages/video/post_panel/view.dart';
import 'package:PiliNext/pages/video/send_danmaku/view.dart';
...
import 'package:PiliNext/services/download/download_service.dart';
...
import 'package:PiliNext/utils/extension/size_ext.dart';
...
class VideoDetailController extends GetxController
  ...
  Future<void> queryVideoUrl({
    ...
    final requestGeneration = ++_videoUrlRequestGeneration;
    if (isFileSource) {
      return _initPlayerIfNeeded(autoFullScreenFlag);
    }
    if (isQuerying) {
      _pendingVideoUrlQuery = (
        defaultST: defaultST,
        fromReset: fromReset,
        autoFullScreenFlag: autoFullScreenFlag,
      );
    ...
    final requestLanguage = currLang.value;
    ...
    try {
      ...
      if (requestGeneration != _videoUrlRequestGeneration ||
          requestBvid != bvid ||
          requestCid != cid.value) {
        return;
      }
      ...
      isQuerying = false;
      if (_pendingVideoUrlQuery case final pending?) {
        _pendingVideoUrlQuery = null;
        if (!isClosed) {
          unawaited(
            queryVideoUrl(
              defaultST: pending.defaultST,
              fromReset: pending.fromReset,
              autoFullScreenFlag: pending.autoFullScreenFlag,
            ),
          );
        }
      }
